    ...
    return (
        <>
            ...
            >
                ...
                <div className="w-full  max-w-sm p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
                    <div className="">
                        <div className="text-center p-5 flex-auto justify-center">
                            ...
                            <h2 className="text-xl font-bold py-4 ">Soft delete user?</h2>
                            <p className="text-sm text-gray-500 px-8">
                                By doing like this will make the user soft delete/ block
                            </p>
                        </div>
